...
describe('Verify assigned Project contributor is able to upload content to the textbooks for the skip review disabled Project', () => {
    ...
    it('verifyAssignedProjectReviewerIsAbleToSubmitForApprovalWithLRAndTR',function(){
         ...
         VDNfun.UploadContentsForLearningResourceAndTeacherResourceAssignedContributer(projectName);
         utility.userLogout();
         utility.userLoginContributer('Rev Only');
         VDNfun.verifyAssignedProjectReviewerIsAbleToSubmitForApprovalWithLRAndTR(projectName);
    })  
});
