...
describe('Verify Total approved corrections pending count updated under created digital textbook project', () => {
    ...
    it('verifyUpdatedCountInDigitalTextbookProject',function(){
