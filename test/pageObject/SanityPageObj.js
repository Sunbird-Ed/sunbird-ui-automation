...
const openBookFromAllBookAndDownloadQRCode=()=>{
    try
    {
        console.log("User is trying to create book")
        browser.sleep(1000);
        ...
        sanityPage.SanityElement().closePage.click();
        browser.sleep(4000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(etbv.allTextBook), 20000, "allTextBook  is not available");
        expect(etbv.allTextBook.getText()).toEqual('All Textbooks');
        etbv.allTextBook.click();
        browser.sleep(1000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(etbv.firstContentWithDraftstatus), 20000, "firstContentWithDraftstatus  is not available");
    ...
    // sanityPage.SanityElement().closePage.click();
    // browser.sleep(4000);
    // browser.wait(protractor.ExpectedConditions.visibilityOf(sanityPage.SanityElement().allTextBook), 20000, "assertDraftField  is not available");
    // expect(sanityPage.SanityElement().allTextBook.getText()).toEqual(' All Textbooks ');
    // sanityPage.SanityElement().allTextBook.click();
    // browser.sleep(1000);
    // browser.wait(protractor.ExpectedConditions.visibilityOf(sanityPage.SanityElement().firstContentWithDraftstatus), 20000, "clkFirstBookDraft  is not available");
    // sanityPage.SanityElement().firstContentWithDraftstatus.click();
    // browser.switchTo().frame(browser.driver.findElement(by.tagName('iframe')));
    // browser.sleep(8000);
    ...
    const declaredUsersCsvFileDownload = ()=>{
        try {
            ...
            browser.sleep(1000);
            browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.dropdownProfile), 20000, "Avatar Content Button is not available");
            sanity.dropdownProfile.click();
...
try{
    ...
    sanityPage.SanityElement().searchBoxForBook.click();
    browser.sleep(3000);
...
const verifySearchBookInLibraryPage=()=>{
    ...
    browser.sleep(2000);
    browser.wait(protractor.ExpectedConditions.visibilityOf(sanityPage.SanityElement().searchBoxForBook), 20000, "Serchbox for QR code  is not available");
    sanityPage.SanityElement().searchBoxForBook.sendKeys('R1N2C8');
    browser.sleep(2000);
    browser.wait(protractor.ExpectedConditions.visibilityOf(sanityPage.SanityElement().clickSeaarchButton), 20000, "SerchButton for QR code  is not available");
    sanityPage.SanityElement().clickSeaarchButton.click();
    browser.sleep(2000);
    ...
    sanityPage.SanityElement().searchBoxForBook.sendKeys('umesh sanity16');
    browser.sleep(2000);
    ...
    sanityPage.SanityElement().searchBoxForBook.sendKeys('do_2130441952511672321254');
    browser.sleep(2000);
...
module.exports = {
    ...
    copyBookAsCourse,
    openBookFromAllBookAndDownloadQRCode,
