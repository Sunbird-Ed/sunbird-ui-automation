...
describe('Content Playlist with Selected Set of contributors and Skip Enabled ', () => {
    ...
    it('verifyOrgAdminIsAbleToCreateAndPublishProjectUsingContentPlaylistandSelectedSetofContributorsSkipEnable',function(){
