...
const sign = require(protractor.basePath +
...
const languageVerify = () => {
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.selectlanguage),
    20000,
  ...
  browser.sleep(1000);
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.hindiLanguage),
    20000,
    "hindiLanguage is not available"
  );
  signUp.hindiLanguage.click();
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.searchTextBox),
    20000,
    "searchTextBox is not available"
  );
  signUp.searchTextBox.sendKeys("हिंदी");
  browser.sleep(2000);
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.clickSearchInHindi),
    20000,
    "clickSearchInHindi is not available"
  );
  ...
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.selectlanguage),
    20000,
    "clickOnLanguageDropdwon is not available"
  );
  signUp.selectlanguage.click();
  ...
  browser.sleep(1000);
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.urduLanguage),
    20000,
    "searchTextBox is not available"
  );
  ...
  browser.sleep(1000);
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.clickSearchInUrdu),
    20000,
    "clickSearchInUrdu is not available"
  );
  ...
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.selectlanguage),
    20000,
    "selectLanguageInUrdu is not available"
  );
  signUp.selectlanguage.click();
  browser.sleep(2000);
  ...
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.searchButton),
    20000,
    "clickSearchInUrdu is not available"
  );
...
const verifyLocationUpdateForUser = () => {
  ...
  if (signUp.district4.isDisplayed() && signUp.state.isDisplayed()) {
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(signUp.stateDropdown),
      20000,
      "stateDropdown is not available"
    );
    signUp.stateDropdown.click();
    browser.sleep(1000);
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(signUp.stateName),
      20000,
      "stateName is not available"
    );
    signUp.stateName.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(signUp.districtDropdown),
      20000,
      "districtDropdown is not available"
    );
    signUp.districtDropdown.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(signUp.districtName),
      20000,
      "districtName is not available"
    );
    signUp.districtName.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(signUp.submitButton2),
      20000,
      "submitButton2 is not available"
    );
    signUp.submitButton2.click();
  }
  if (
    signUp.selectedDistrict.isDisplayed() &&
    signUp.selectedState.isDisplayed()
  ) {
...
const updateMobileEmailAndRecoveryDetails = () => {
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.addPhone),
    20000,
    "addPhone is not available"
  );
  signUp.addPhone.click();
  browser.sleep(1000);
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.enterPhone),
    20000,
    "enterPhone is not available"
  );
  signUp.enterPhone.sendKeys("9538012073");
  signUp.closeIcon.click();
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.addRecoveryMail),
    20000,
    "addRecoveryMail is not available"
  );
  signUp.addRecoveryMail.click();
  browser.sleep(1000);
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.enterRecoveryMail),
    20000,
    "enterRecoveryMail is not available"
  );
  ...
  signUp.addRecoveryMail.click();
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.selectPhone),
    20000,
    "selectPhone is not available"
  );
  signUp.selectPhone.click();
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(signUp.enterRecoveryPhone),
    20000,
    "enterRecoveryPhone is not available"
  );
...
const navigateToParticularCourseAndSearchForOpenBatch = (courseName) => {
  try {
    ...
    console.error(
      "Failed on navigating to Course section and search course : " + Exception
    );
  }
};
...
const enrollForOpenBatch = () => {
  try {
    ...
    browser.sleep(2000);
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.resumeCourse),
      20000,
...
const consumeAndVerifyConsumptionForNoContents = (progressStatus) => {
  try {
    console.log(
      "User is trying to consume And Verify Consumption For No Contents"
    );
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.courseProgress),
      20000,
      "courseProgress not available"
    );
    ...
    console.log(
      "User successfully consumed And Verified Consumption For No Contents "
    );
  } catch (Exception) {
...
const consumeAndVerifyConsumptionFor10Contents = (progressStatus) => {
  try {
    console.log(
      "User is trying to consume And Verify Consumption For 10 Contents : " +
        progressStatus
    );
    browser.switchTo().frame(browser.driver.findElement(by.tagName("iframe")));
    browser.sleep(1000);
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.nextArrowInContents),
      20000,
      "nextArrowInContents not available"
    );
    var nextArrowIcon = expect(searchObj.nextArrowInContents.isPresent()).toBe(
      true
    );
    if (nextArrowIcon) {
      ...
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.EnjoyedTheContent),
        20000,
        "EnjoyedTheContent not available"
      );
      browser.wait(
      ...
      var statusOfProgress = searchObj.courseProgress
        .getText()
        .then(function (input) {
          expect(input);
        });
      if (statusOfProgress != "Your Progress 100%") {
        browser.executeScript(
          ...
          searchObj.nextButtonInCourseConsumption
        );
        browser.wait(
          ...
          20000,
          "nextButtonInCourseConsumption not available"
        );
        searchObj.nextButtonInCourseConsumption.click();
      }

      var progress10 = searchObj.courseProgress
        .getText()
        .then(function (input) {
          expect(input);
        });
      ...
      console.log(
        "User successfully consumed And Verified Consumption For 10 Contents : " +
          progressStatus
      );
    }
  } catch (Exception) {
    console.log(
      "Failed to consume And Verify Consumption For 10 Contents : " +
        progressStatus
    );
  }
};
...
const unrollForOpenBatch = () => {
  try {
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.closeIcon2),
      20000,
      "closeIcon2 not available"
    );
    ...
    if (searchObj.unEnrollButton.isEnabled()) {
      ...
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.unEnrollButton2),
        20000,
        "unEnrollButton2 not available"
      );
      searchObj.unEnrollButton2.click();

      browser.executeScript(
        "arguments[0].scrollIntoView();",
        searchObj.assertUnEnroll
      );
      var resumecourseStatus = expect(
        searchObj.assertUnEnroll.isPresent()
      ).toBe(true);
      ...
      console.log(
        "unenroll button is not available because course is 100% consumed"
      );
    } else {
      console.log(
        "unenroll button is not available even if course is not 100% consumed"
      );
    }
  } catch (Exception) {
...
const checkTheCourseInMyCourseSection = (expectedCoursName) => {
  try {
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.myLatestCousreCount),
      20000,
      "myLatestCousreCount  is not available"
    );
    ...
    try {
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(
          searchObj.myLatestCoursNextButton
        ),
        20000,
        " searchPublishedCourses is not available"
      );
...
const verifyCourseResumedFromSameCourseAfterStopingTheconsumption = () => {
  try {
    ...
    browser.executeScript(
      "arguments[0].scrollIntoView();",
      searchObj.consumedcontentName
    );

    var contentName = searchObj.consumedcontentName
      .getText()
      .then(function (input) {
        expect(input);
      });
    ...
    var newContentName = searchObj.consumedcontentName
      .getText()
      .then(function (input) {
        expect(input);
      });
...
const trainingAttendedIsAvailableInProfilePage = () => {
  try {
    console.log(
      "User is trying to see the training attended section in profile"
    );
    ...
    searchObj.courseCard.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.hundredProgressBar),
      20000,
      "hundredProgressBar not available"
    );
    console.log("Your Progress 100%");
    console.log("User has completed the course upto 100%");
    var courseName = searchObj.courseNameInContentPlayer
      .getText()
      .then(function (input) {
        expect(input);
      });
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.dropdown),
      20000,
      "dropdown not available"
    );
    searchObj.dropdown.click();
    browser.wait(
      protractor.ExpectedConditions.elementToBeClickable(searchObj.logout),
      20000,
      "logout not available"
    );
    browser.wait(
      protractor.ExpectedConditions.isDisplayed(searchObj.clickProfileIcon),
      20000,
      "clickProfileIcon not available"
    );
    searchObj.clickProfileIcon.click();
    console.log("User lands on Profile Page");
    browser.executeScript(
      "arguments[0].scrollIntoView();",
      searchObj.viewMoreButton
    );
    var vewMoreButtonStatus = expect(searchObj.viewMoreButton.isPresent()).toBe(
      true
    );
    if (vewMoreButtonStatus) {
      searchObj.viewMoreButton.click();
    }
    var downloadOption = expect(searchObj.downloadCertificate.isPresent()).toBe(
      true
    );
    if (downloadOption) {
      console.log(
        "User successfully Verified download certificate option is available"
      );
...
const consumeAndVerifyConsumptionFor3Contents = (progressStatus) => {
  try {
    console.log(
      "User is trying to consume And Verify Consumption For 3 Contents : " +
        progressStatus
    );
    console.log(
      "User is trying to consume And Verify Consumption For 3 Contents"
    ...
    if (searchObj.nextArrowInContents.isPresent()) {
      ...
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.starRating),
        20000,
        "starRating is not available"
      );
      searchObj.starRating.click();
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.submitRating),
        20000,
        "submitRating  is not available"
      );
      searchObj.submitRating.click();
      ...
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.courseProgress),
        40000,
        "courseProgress is not available"
      );
      searchObj.courseProgress.getText().then(function (statusOfProgress) {
        ...
        if (statusOfProgress.contains("100%")) {
          ...
          browser.wait(
            ...
            20000,
            "nextButtonInCourseConsumption is not available"
          );
          searchObj.nextButtonInCourseConsumption.click();
        }
      });
    ...
    console.log(
      "User successfully consumed And Verified Consumption For 3 Contents : " +
        progressStatus
    );
  } catch (Exception) {
    console.log(
      "Failed to consume And Verify Consumption For 3 Contents : " +
        progressStatus
    );
  }
};
...
const checkProgressBarInTOC = () => {
  try {
    ...
    if (searchObj.closeCourseButton.isDisplayed()) {
      ...
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.closeCourseButton),
        20000,
        " searchPublishedCourses is not available"
      );
...
const copyCourseFromSameTenant = () => {
  try {
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.courseCard1),
      40000,
      "validateLatestCourse is not available"
    );
    searchObj.courseCard1.click();
    expect(
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.copyCourse)
      )
    ).toBeTruthy;
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.copyCourseContent),
      40000,
      "copyCourseContent is not available"
    );
...
const saveAndSendNewCourseForReview = () => {
  try {
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.saveCourse),
      40000,
      "saveCourse is not available"
    );
    searchObj.saveCourse.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.sendForReview),
      40000,
      "sendForReview is not available"
    );
    searchObj.sendForReview.click();
    console.log(
      "Content creator should be able to click on send for review button, to send the content for review."
    );
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.clickAppIcon),
      50000,
      "clickAppIcon is not available"
    );
    searchObj.clickAppIcon.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.checkAppIcon),
      40000,
      "checkAppIcon is not available"
    );
    searchObj.checkAppIcon.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.selectAppIcon),
      40000,
      "selectAppIcon is not available"
    );
    searchObj.selectAppIcon.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.topic),
      20000,
      "topic not available"
    );
    searchObj.topic.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.topicSelectorImg),
      20000,
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(
        searchObj.topicSelectorContent
      ),
      20000,
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.topicSelectorDone),
      20000,
    ...
    browser.executeScript(
      "arguments[0].scrollIntoView();",
      searchObj.clickMedium
    );
    searchObj.clickMedium.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.selectMedium),
      30000,
      "selectMedium button not available"
    );
    searchObj.selectMedium.click();

    try {
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.author),
        30000,
        "author button not available"
      );
...
const reviewInSubmissions = () => {
  ...
  try {
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.reviewSubmission),
      40000,
      "workSpace is not available"
    );
    ...
    searchObj.coursename.getText().then(function (courseName1) {
      ...
      console.log(
        "Content creator should be able to see the content under Submitted for review section post sending"
      );
    });
    return courseName1;
  } catch (e) {
...
const searchInUpForReviewAndPublish = (source) => {
  try {
    ...
    console.log("Clicked on WorkSpace");
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.upForReview),
      40000,
      "upForReview is not available"
    );
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(
        searchObj.searchedContentForPublish
      ),
      40000,
      "searchedContentForPublish is not available"
    );
...
const publishAndSearch = (source1) => {
  try {
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(
        searchObj.publishCourseButton1
      ),
      40000,
      "publishCourseButton is not available"
    );
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.popupPublishButtons),
      40000,
      "popupPublishButtons is not available"
    );
...
const checkCreditSection = () => {
  try {
    ...
    expect(
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.msgDerivedFrom)
      )
    ).toBeTruthy;
    ...
    expect(
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.authorName)
      )
    ).toBeTruthy;
    console.log("Author name is displayed ");
    expect(
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.licenceTerms)
      )
    ).toBeTruthy;
    console.log("licence terms are displayed ");
    expect(
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.publishedDetails)
      )
    ).toBeTruthy;
    console.log("published by is also dispalyed ");
    expect(
      browser.wait(
        protractor.ExpectedConditions.visibilityOf(searchObj.attributionName)
      )
    ).toBeTruthy;
...
const navigateToWorkspace = () => {
  try {
    ...
    searchObj.workSpace.click();
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.published),
      40000,
      "workSpace is not available"
    );
...
const deleteCreatedItems = () => {
  try {
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(
        searchObj.firstCourseCardContentName
      ),
      40000,
      "firstCourseCardContentName is not available"
    );
    searchObj.firstCourseCardContentName
      .getText()
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.yesButtonPopup),
      40000,
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(searchObj.messageBox),
      40000,
      "messageBox is not available"
    );
