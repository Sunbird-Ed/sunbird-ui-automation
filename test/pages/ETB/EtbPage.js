...
let EtbElem = () => {
    ...
    var publishedIcon = element(by.xpath("//a[@popuptext='View all your published content']"));
    var publshedSearch = element(by.xpath("(//input[@name='filter_search'])[2]"));
    var firstPublishedBook = element(by.xpath("(//a[text()='Digital Textbook']/following-sibling::img)[1]"));
    var editDetails = element(by.xpath("//span[@ng-if='showEditMeta']"));
    var editPublisher = element(by.xpath("(//input[@name='publisher'])[1]"));
    var editOriginalAuthor = element(by.xpath("(//input[@name='author'])[1]"));
    var editYearOfCreation = element(by.xpath("//input[@placeholder='Enter Year of Creation']"));
    var saveButton = element(by.xpath("//button[text()='Save']"));
    ...
    var PublishedDD = element(by.xpath("//*[contains(text(),'Select User Type')]"));
    ...
    var defaultValueClass = element(by.xpath("//label[contains(text(),'Class')]//following::div[4]"));
    var CoursecontentInSubjectWise = element(by.xpath("//div[@class='sb-card-image']//following::div[3]"));
    var clkAdminDashBoard = element(by.xpath("//li[contains(text(),'Admin dashboard')]"));
    var clkFirtReport = element(by.xpath("//div[@class='sb-media']"));
    var veriryCanvas = element(by.xpath("//canvas[@class='chartjs-render-monitor']"));

    var fetchBoardValue = element(by.xpath("//label[contains(text(),'Board')]//following::span[2]"));
    ...
    return {
        ...
        subjectNoDefDD,
        PublishedDD,
        contentInSubjectWise,
        defaultValueCBSEDD,
        defaultValueEnglish,
        defaultValueClass,
        CoursecontentInSubjectWise,
        clkAdminDashBoard,
        clkFirtReport,
        veriryCanvas,
        publishedIcon,
