...
describe('validateAllFilterTypesInHomeTabByCategoriesAndSubject', () => {
    ...
    it('validateAllFilterTypesInHomeTabByCategoriesAndSubject', function () {
        ...
        tpdPageObj.validateFiltersInBrowseBySubject();
        tpdPageObj.homeTabwithBrowseByCategories();
        tpdPageObj.validateFiltersInBrowseByCategriesWithHomeTab();
        utility.userLogout();
    })
});