...
describe('User clicks on Edit option under the action column to go to Conversation Setup screen', () => {
    ...
    it('veryUserClicksOnEditOptionUnderTheActionColumnToGoToConversationFlowScreen',function(){
        ...
        EnrollTBFCPageObj.veryUserClicksOnEditOptionUnderTheActionColumnToGoToConversationFlowScreen();
    })
});