...
const userLogout = () => {
    try {
        ...
        browser.sleep(4000);
        wait.waitForElementVisibility(content.profileHeaderDropDown, 20000);
        content.profileHeaderDropDown.click();
        browser.sleep(300);
        // browser.executeScript("arguments[0].scrollIntoView();", content.logout);
        // browser.sleep(200);
        wait.waitForElementVisibility(content.vdnLogout, 20000);
        content.vdnLogout.click();
        browser.sleep(300);
        browser.get(Url + AppendExplore, 40000);
        browser.sleep(2000);
    } catch (err) {
...
const selectPastDateForNominationEndDate = () => {
    try {
        var date = new Date();
...
const selectPastDateForShortlistEndDate = () => {
    try {
        var date = new Date();
        var day = date.getDate()-1;
        var year = date.getFullYear();
...
const selectPastDateForContributionEndDate = () => {
    try {
        var date = new Date();
        var day = date.getDate()-1;
        var year = date.getFullYear();
...
const selectPastDateForProjectEndDate = () => {
    try {
        var date = new Date();
        var day = date.getDate();
        var year = date.getFullYear();
...
const nominationEndDateExpected = () => {
    try {
        var date = new Date();
        var day = date.getDate()-1;
        var year = date.getFullYear();
        ...
        var expectdate = ",";
        var month = monthNames[date.getMonth()];
        newdate = month + " " + day + expectdate + " " + year;
        return newdate;
    } catch (Err) {
        console.error("Failed , " + Err);
    }
...
const shortlistEndDateExpected = () => {
    try {
        var date = new Date();
        var day = date.getDate()-1;
        var year = date.getFullYear();
...
const contributionEndDateExpected = () => {
    try {
        var date = new Date();
        var day = date.getDate()-1;
        var year = date.getFullYear();
...
const userLoginContributer = (roleName) => {
    try {
...
const userLoginSourcing = (roleName) => {
    try {
...
module.exports = {
    ...
    projectEndDate,
    selectPastDate,
    nominationEndDateExpected,
    uploadParticularFile,
    userLoginContributer,
    selectPastDateForNominationEndDate,
    selectPastDateForShortlistEndDate,
    selectPastDateForContributionEndDate,
    selectPastDateForProjectEndDate,
    shortlistEndDateExpected,
    contributionEndDateExpected,
    projectEndDateExpected,
    userLogoutContribute,
    userLoginSourcing,
