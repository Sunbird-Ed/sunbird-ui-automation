...
const tptPage = require(protractor.basePath + '/test/pageObject/tpdPageObj.js');
...
describe('upload pdf, save and send for review and publish.', () =>{
    ...
    it('ProperPreviewShownForHTMLuploadContentInAllMyContentSection ',function(){
        ...
        tptPage.ProperPreviewShownForUploadContentInAllMyContentSection(html);
