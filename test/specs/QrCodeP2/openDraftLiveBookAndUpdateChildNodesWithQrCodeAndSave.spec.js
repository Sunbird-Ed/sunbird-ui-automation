...
describe('openDraftLiveBookAndUpdateChildNodesWithQrCodeAndSave', () => {
    beforeEach(() => {
    ...
    it('openDraftLiveBookAndUpdateChildNodesWithQrCodeAndSave', function () {
        ...
        utility.userLogout();
        utility.userLogin('ContentCreator');
        cont.editBookAndAddValidQrCodeAndSave(bookName);
    })
});