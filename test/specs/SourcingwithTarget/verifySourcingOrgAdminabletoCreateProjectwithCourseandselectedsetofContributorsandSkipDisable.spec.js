...
describe('create Project with course Selected Set of contributors and skip disable ', () => {
    ...
    it('verifyOrgAdminIsAbleToCreateProjectwithcourseandSelectedSetofContributorsskipDisable',function(){
