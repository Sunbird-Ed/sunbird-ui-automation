...
describe('userAssignedAsAdminAllowedToLeaveGroup', () => {
    beforeEach(() => {
    ...
    it('userAssignedAsAdminAllowedToLeaveGroup', function () {
        ...
        let groupName = sanityfun.verifyAddActivitySearchedByKeywordInCourseBucket("AutomationCourseCompletedBatch");
