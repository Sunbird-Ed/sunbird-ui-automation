...
const tpdPage = () => {
    ...
    var cancel = element(by.xpath("//button[contains(text(),'Cancel')]"));
  ...
  //  var botIDHeading = element(by.xpath("//th[text()=' Bot Id ']"));
    ...
    var KebabOptOnActionColumn = element(by.xpath("//i[@class='ellipsis vertical icon ellipsis-icon dropdown']"));
    var editOptOnActionColumn = element(by.xpath("//div[contains(text(),'Edit')]"));
    var deleteOptOnActionColumn = element(by.xpath("//div[contains(text(),'Delete')]"));
    var DisableOptOnActionColumn = element(by.xpath("//div[contains(text(),'Disable')]"));
    var inputSearchName = element(by.xpath("//input[@placeholder='Search']"));
    var clkSearchName = element(by.xpath("//*[contains(text(),'Conversations')]//following::button[2]"));
    ...
    var assertStartingMsg = element(by.xpath("//*[contains(text(),'Starting message ')]")); 
    var assertNextButton = element(by.xpath("//button[contains(text(),'Next')]"));
    ...
    var assertAddLogicBtn = element(by.xpath("//button[contains(text(),' Add logic ')]"));
    ...
    var backBtnConvFlow = element(by.xpath("//button[contains(text(),'Back')]"));
