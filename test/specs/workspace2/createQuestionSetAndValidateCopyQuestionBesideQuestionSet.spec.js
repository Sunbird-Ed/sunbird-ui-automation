...
describe('createQuestionWithMathematicalEquations', () => {
    ...
    it('createQuestionSetAndValidateCopyQuestionBesideQuestionSet',function(){
        utility.handleDropDown();
       utility.handleLocationPopup();
        utility.userLogin('ContentCreator');
        let contentName=resourcePageObj.createQuestionSetWithCopyQuestionValidationInResource();
