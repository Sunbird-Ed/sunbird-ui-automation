...
const lspPageObj = require(protractor.basePath+'/test/pageObject/tpdPageObj.js');
describe('verifyThatGroupAdminSeesTheActivityDashboardWhenUserOpenTheCourse', () => {
    ...
    it('verifyThatGroupAdminSeesTheActivityDashboardWhenUserOpenTheCourse ',function(){
