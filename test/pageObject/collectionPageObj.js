...
const sendForReviewTheCollection = () => {
  ...
  browser.sleep(5000);
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(etbv.clickAppIcon),
    50000,
  ...
  browser.sleep(1000);
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(etbv.checkAppIcon),
    50000,
    "checkAppIcon button not available"
  );
  etbv.checkAppIcon.click();
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(etbv.selectAppIcon),
    50000,
...
const publishTheCollectionFromUpForReview = (collectionname) => {
  ...
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(content.popupPublishButton1),
    20000,
    "Creation page not loaded"
  );
...
const clickLibraryPage = () => {
  try {
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(content.clickLibray),
      20000,
      "clickLibray is not available"
    );
...
const shareTheConentUsingLink = (contentName) => {
  ...
  try {
    console.log(
      "User is trying to verify Course can be shared via link  " + contentName
    );
...
const verifyResource = () => {
  ...
  try {
    browser.get(
      "https://preprod.ntp.net.in/play/content/do_31257982245632409629620",
      40000
    );
    browser.sleep(2000);
    console.log("Add Copied link in URL");
...
const clickTrainingPage = () => {
  try {
    ...
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(content.headerCourse),
      20000,
...
const ZoomInZoomout = () => {
  try {
    ...
    browser.sleep(2000);
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(content.zoomIn),
      20000,
      "zoomIn is not available"
    );
    content.zoomIn.click();
    browser.sleep(3000);
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(content.zoomOut),
      20000,
      "zoomOut is not available"
    );
...
const SearchAddContentInCollection = () => {
  ...
  try {
    ...
    expect(sanityPage.SanityElement().searchContentFromLibrary.isPresent())
      .toBeTruthy()
      .then(function () {
...
const validatecollectionAttributes = () => {
  try {
    console.log(
      "User is validating Name,Description and Collection type attributes after clicking on collection button"
    );
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(content.headerDropdown),
      20000,
    ...
    expect(content.name.isDisplayed())
      .toBeTruthy()
      .then(function () {
        collectionName = "CollectionA" + faker.randomData().firstname;
        content.name.sendKeys(collectionName);
        console.log(
          "Name entry box is validated after clicking collection button"
        );
        browser.sleep(3000);
      });
    expect(content.collectionDescription.isDisplayed())
      .toBeTruthy()
      .then(function () {
        console.log(
          "Description Entry box is validated after clicking collection button"
        );
        browser.sleep(3000);
      });
    expect(etbv.collectionType.isDisplayed())
      .toBeTruthy()
      .then(function () {
        etbv.collectionType.click();
        browser.sleep(3000);
        console.log(
          "CollectionType is validated after clicking collection button"
        );
    ...
    console.log(
      "User is failed to validate Name,Description and Collection type attributes after clicking on collection button"
    );
  }
};
...
const sendForReviewTheCollectionWithimageIcon = () => {
  ...
  browser.sleep(1000);
  browser.wait(
    protractor.ExpectedConditions.visibilityOf(etbv.collAppIcon),
    50000,
    "checkAppIcon button not available"
  );
...
const createCollectionWithDiffCollectionTypesAndSaveAsDraft = (
  collectionType
) => {
  var collectionName;
  try {
...
const createCollectionWithDiffCollectionTypesAndValidateAddedContent = (
  collectionType
) => {
  var collectionName;
  try {
    ...
    sanityPage.SanityElement().addFromLibraryButton.click();
    browser.sleep(3000);
    var searchLibraryContent = "AutomationCourseForDF";
    sanityPage
      .SanityElement()
      .searchContentFromLibrary.sendKeys(searchLibraryContent);
    sanityPage
      .SanityElement()
      .searchContentFromLibrary.sendKeys(protractor.Key.ENTER);
    browser.sleep(3000);
...
const createCollectionWithDiffCollectionTypesAndValidateAddedQrCode = (
  collectionType
) => {
  var collectionName;
  try {
    ...
    ccpage.contentCreation().qrCodeRequred.click();
    browser.sleep(5000);
    sanity.EnterQRCode.sendKeys("M7L4L1");
    browser.sleep(2000);
    sanity.clickRight.click();
    browser.sleep(2000);
    browser.executeScript("window.scrollTo(0,800);").then(function () {
      console.log("++++++SCROLLED Down+++++");
    });
...
const createCollectionWithDiffCollectionTypesAndValidateLimitedSharing = (
  collectionType
) => {
  var collectionName;
  try {
    ...
    // expect(( sanityPage.SanityElement().assertAddedContent).isPresent()).toBe(true);
    // browser.sleep(3000);
    expect(searchObj.clickLimitedSharing.isPresent()).toBe(false);
    browser.sleep(3000);
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(
        sanityPage.SanityElement().submitForreviewButton
...
const createCollectionAndValidateAdditionalCategory = () => {
  var collectionName;
  try {
    console.log("User is trying to create a collection");
    browser.wait(
    ...
    browser.sleep(3000);
    sanity.clkAdditionalCategoryDrpDwn.click();
    browser.sleep(3000);
    var assertCollection = console.log(assertCollection);
    sanity.assertCollectionCategory.getText().then(function (input) {
      input.includes("Lesson Plan");
    });
    browser.sleep(3000);
    sanity.clkAdditionalCategoryDrpDwn.click();
    browser.sleep(4000);
...
const createCollectionandSendForReview = (collectionType) => {
  var collectionName;
  try {
    console.log("User is trying to create a collection");
    browser.wait(
...
const createCollectionWithTitleAndOrgFramework = () => {
  var collectionName;
  try {
    console.log("User is trying to create a collection");
    browser.wait(
...
const validateSameTitleAndOrgFrameInConsumptionPartUsedInCreatingCollection = (
  collectionTitle
) => {
  try {
    console.log(
    ...
    browser.sleep(2000);
    content.filterSearch.sendKeys(collectionTitle);
    browser.sleep(2000);
    content.searchIcon.click();
    browser.sleep(2000);
    browser.wait(
      protractor.ExpectedConditions.visibilityOf(
        content.searchedContentForUpload
      ),
      20000,
      "searchedContentForUpload is not available"
    );
    content.searchedContentForUpload.click();
    browser.sleep(3000);
    expect(content.assertTitleOfCollection.getText()).toEqual(collectionTitle);
    browser.sleep(3000);
    browser.executeScript("window.scrollTo(0,800);").then(function () {
      console.log("++++++SCROLLED Down+++++");
    });
...
module.exports = {
  ...
  submitForReview,
  createCollectionWithDiffCollectionTypesAndValidateAddedContent,
