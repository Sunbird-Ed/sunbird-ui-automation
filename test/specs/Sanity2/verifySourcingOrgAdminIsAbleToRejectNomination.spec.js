...
describe('Verify sourcing org admin is able to reject  nomination', () => {
    ...
    it('verifySourcingOrgAdminIsAbleToRejectNomination',function(){
         ...
         utility.userLogout();
         utility.userLogin('Admin');
         VDNfun.verifySourcingOrgAdminIsAbleToRejectNomination(projectName);
    })  
});