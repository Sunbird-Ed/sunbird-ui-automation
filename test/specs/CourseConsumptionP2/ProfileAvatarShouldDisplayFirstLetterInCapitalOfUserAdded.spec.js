...
describe('VerifyAddUserAndSwitchedUserProfile', () => {
    ...
    it('ProfileAvatarShouldDisplayFirstLetterInCapitalOfUserAdded',function(){
        utility.handleDropDown();
        utility.handleLocationPopup();
        utility.userLogin('AddUserCred');
        usrOnBoardfun.AddUserWithSpecificName();
        usrOnBoardfun.naviageToProfilePage();
        usrOnBoardfun.firstLetterInCapitalInProfileAvathar();
