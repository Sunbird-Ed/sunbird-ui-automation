...
describe('able to create course and enroll consume ValidateCreateBatchAndConsentFormWhileEnroll', () => {
    ...
    it('verifThatUserCanSeeTwoCourseCardsInProfileAsWellAsMyCourses', function () {
        ...
        EnrollTBFCPageObj.verifThatUserCanSeeTwoCourseCardsInProfileAsWellAsMyCourses(courseName);     
    })
});