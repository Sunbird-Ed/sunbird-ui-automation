...
describe('Verify sourcing org reviewer is able to reject the content ', () => {
    ...
    it('verifyRejectedCountUnderTextBookAndYourOrganisation',function(){
         ...
         VDNfun.verifyPostRejectionValidateRejectedCount(projectName);
