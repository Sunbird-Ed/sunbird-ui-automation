...
var sltBoardDdAllTabs = element(by.xpath("//label[contains(text(),'Board ')]//following::span[2]"));

var clkMediumDdAllTabs = element(by.xpath("//label[contains(text(),'Medium ')]//following::div[1]"));
var sltMediumDdAllTabs = element(by.xpath("//label[contains(text(),'Medium ')]//following::span[2]"));
var sltMedium2DdAllTabs = element(by.xpath("//label[contains(text(),'Medium ')]//following::span[4]"));

var clkClassDdAllTabs = element(by.xpath("//label[contains(text(),'Class ')]//following::div[1]"));
var sltClassDdAllTabs = element(by.xpath("//label[contains(text(),'Class ')]//following::sui-select-option[1]//following::span[1]"));
var sltClass2DdAllTabs = element(by.xpath("//label[contains(text(),'Class ')]//following::sui-select-option[1]//following::span[3]"));
...
var sltSubjectDD2dAllTabs = element(by.xpath("//label[contains(text(),'Subject ')]//following::span[4]"));
