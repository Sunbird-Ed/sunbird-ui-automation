...
describe('Verify assigned Project contributor is able to upload content to the textbooks for the skip review disabled Project', () => {
    ...
    it('verifyAssignedProjectReviewerIsAbleToSubmitForApprovalWithETextBookAndEC',function(){
         ...
         VDNfun.UploadExplinationCntentAfterUploadingUploadingEtext(projectName);
         utility.userLogout();
         utility.userLoginContributer('Rev Only');
         VDNfun.verifyAssignedProjectReviewerIsAbleToSubmitForApprovalWithETextBookAndEC(projectName);
