...
describe('Course reviewer is able to rejects the SelfAssesmentcourse .', () => {
    ...
    it('EditAlreadyPublishedCourseAssesmentAndPublishAgain', function () {
        ...
        utility.userLogout();
        utility.userLogin('ContentCreator');
   resourcePageObj.editPublishedQuestionSetInCourseAssessment(courseName);
   tpdPageObj.CourseAssessmentSendReviewWithAlreadyFilledDetails();
               utility.userLogout();
        utility.userLogin('ContentReviewer');
                resourcePageObj.publishTheResourceFromUpForReview(courseName);
    })
