...
describe('Default contribution org contributor should be able to upload the content for skip review enabled project', () => {
    ...
    it('verifydefaultContributionOrgReviewerIsAbleToPreview',function(){
         utility.userLogin('Admin');
         let projectName = VDNfun.createProjectWithoutTargetCollection();
         console.log(projectName);
         utility.userLogout();
         utility.userLoginContributer('Admin');
         VDNfun.assignDefaultContributorOrgAdminToReviewerAndContributer(projectName);
         utility.userLogout();
         utility.userLoginContributer('OrgCont Only');
         VDNfun.addSampleFromContriutionSide(projectName);
         utility.userLogout();
         utility.userLoginContributer('OrgRev Only');
         VDNfun.verifyDefaultOrgUserWithReviewerAsRoleIsAbleToReviewTheContent(projectName);
         utility.userLogout();
    })  
});
