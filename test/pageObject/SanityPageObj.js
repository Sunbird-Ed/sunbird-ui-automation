...
const veriyMaximumAttempts = () => {
    try {
        ...
        sanityPage.SanityElement().submitButtonAfterRating.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.backButton), 20000, "back button not available");
...
const verifyCreateMyGroupAddMember = () => {
    try {
        ...
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.closeMemberDialog), 40000, "Add member button not available");
...
const FillBmesWhileCreatingBookForApTenant = () => {
    try {
        ...
        etbv.SltBoardInBook.click();
        browser.sleep(200);
        wait.waitForElementVisibility(etbv.clkMediumForAPtenant, 20000, "clkBoardInBook is not available");
        etbv.clkMediumForAPtenant.click();
        browser.sleep(200);
        wait.waitForElementVisibility(etbv.sltGradeValueForApTenant, 20000, "clkBoardInBook is not available");
        etbv.sltGradeValueForApTenant.click();
        browser.sleep(200);
        wait.waitForElementVisibility(etbv.clkSubjectForApTenant, 20000, "clkBoardInBook is not available");
        etbv.clkSubjectForApTenant.click();
        browser.sleep(200);
        wait.waitForElementVisibility(etbv.sltSubjectForApTenant, 20000, "clkBoardInBook is not available");
        etbv.sltSubjectForApTenant.click();
        browser.sleep(200);
        wait.waitForElementVisibility(etbv.clkMediumForApTenant, 20000, "clkBoardInBook is not available");
        etbv.clkMediumForApTenant.click();
        browser.sleep(200);
        wait.waitForElementVisibility(etbv.sltMediumForApTenant, 20000, "clkBoardInBook is not available");
        etbv.sltMediumForApTenant.click();
        browser.sleep(100);
        wait.waitForElementVisibility(etbv.publisherEntryBoxForApTenant, 20000, "publisher is not available");
        etbv.publisherEntryBoxForApTenant.sendKeys("TestPublisher");
        browser.sleep(100);
        wait.waitForElementVisibility(etbv.clkYeardropDwnForapTenant, 20000, "publisher is not available");
        etbv.clkYeardropDwnForapTenant.click();
        browser.sleep(100);
        wait.waitForElementVisibility(etbv.sltYearForAPtenant, 20000, "publisher is not available");
...
const TargetFrameworkWithMultipleCategoricalValues = (FrameworkName) => {
    try {
        ...
        courseName = "courseA" + faker.randomData().firstname;
        sanity.addCourseTitle.sendKeys(courseName);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.addCourseTagForCourse), 20000, "tag not available");
...
const updateDiscussionForumPost = () => {
    try {
        browser.sleep(8000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanityPage.SanityElement().searchBoxForBook), 20000, "Serchbox for QR code  is not available");
        sanityPage.SanityElement().searchBoxForBook.sendKeys('do_213441224225660928138');
        browser.sleep(5000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanityPage.SanityElement().clickSeaarchButton), 20000, "SerchButton for QR code  is not available");
        sanityPage.SanityElement().clickSeaarchButton.click();
        browser.sleep(5000);
...
const validateGroupCreation = () => {
    try {
        ...
        var adminText = searchObj.addedSuccessfully.getText();
        browser.sleep(2000);
        expect((sanity.assertGroupGuidelinesPopUp).isPresent()).toBe(false);
        browser.sleep(2000);
        expect((adminText).isDisplayed()).toBe(true);
    } catch (Exception) {
        console.log('failed');
...
const SearchWithDoIdForSummeryTypeAsComplete = () => {
    ...
    try {
        ...
        browser.sleep(5000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.QuestionSetImageGenre), 20000, "First search book not available");
...
const SearchWithDoIdForSummeryTypeAsScore = () => {
    ...
    try {
        ...
        console.log("User is able to get the name of searched content in default ALL tab menu");
        browser.sleep(5000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.QuestionSetImageScore), 20000, "First search book not available");
...
const SearchWithDoIdForSummeryTypeAsDuration = () => {
    ...
    try {
        ...
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.QuestinSetTitle3), 20000, "Valid Question Set Title Is not Added");
        ...
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.instructionQuestionSet3), 20000, "Instructions On Question Set Is Invalid");
...
const verifyTestModewithMaximumNoOfAttempts = () => {
    try {
        ...
        // console.log("User is able to get the name of searched content in default ALL tab menu");
        // browser.sleep(5000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.QuestionSetImage11), 20000, "First search book not available");
...
const changeDifferentRolesAndValidateObservatioTab = () => {
    try {
        ...
        browser.sleep(5000);
        expect(sanity.observationTab.isPresent()).toBe(false).then(function (input) {
            if (input!=true) {
                browser.sleep(5000);
...
const enableDisableDiscussionForumToValidateTags = () => {
    try {
        ...
        sanityPage.SanityElement().submitButton.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.tagsButton), 20000, "submitButton is not available");
        searchObj.tagsButton.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.tagIcon), 20000, "submitButton is not available");
        searchObj.tagIcon.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanityPage.SanityElement().discussCard), 20000, "submitButton is not available");
...
const createCourseWithKeyword = () => {
    ...
    try {
        ...
        browser.sleep(500);
        sanityPage.SanityElement().addCourseTagForCourse.sendKeys(protractor.Key.ENTER);
        browser.sleep(2000);
...
const validateRelevantSection = () => {
    try {
        ...
        browser.sleep(1000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.relevantSection), 20000, "courseCard not available");
...
const validateCourseRelevantSection = () => {
    try {
        ...
        browser.sleep(1000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.BackButton), 20000, "courseCard not available");
        sanity.BackButton.click();
        browser.sleep();
    }
    catch (Err) {
...
const validateColorCode = async () => {
    try {
        ...
        searchObj.courseCard.click();
        browser.sleep(3000);
        var colourUsed = await (sanity.questionNextSlide).getCssValue('background-color');
...
const validateGreyedOutFullScreenButtonAfterConsumingToCertainExtent = async () => {
    try {
        console.log("search particular question set by Do_id ");
        var sheetPath = getExcelPath.ConfigurePath().excelSheetPath;
        var cred = genericFun.readParticularDataFromExcelFile(sheetPath, '4');
...
const validateGreyedOutFullScreenButtonAfterConsumingToCertainExtentOfCourseAssessment = async () => {
    try {
        console.log("search particular question set by Do_id ");
        var sheetPath = getExcelPath.ConfigurePath().excelSheetPath;
        var cred = genericFun.readParticularDataFromExcelFile(sheetPath, '3');
...
const verifyDownlaodedCSVFile = async () => {
    try {
        browser.sleep(5000);
        var filename = getExcelPath.ConfigurePath().downloadLocalPath + "createfoldersamplecsvfile.csv";
...
const writeToCSV = async () => {
    try {
        ...
        let csv = genericFun.writeDataInToCSVlFile("C:\\Users\\Qualitrix\\Downloads\\AutomationCourseCompletedBatch.csv",1,2);
    console.log(csv);
...
const validateContentDetails = () => {
  ...
  const verifyFeedbackPopUpWhenShowFeedbackIsEnabled = () => {
    ...
    try {
        ...
        expect(sanity.assertBorderColorOfTheOpt.isPresent()).toBeTruthy().then(function () {
        ...
        expect(sanity.assertWrongProgress.isPresent()).toBeTruthy().then(function () {
...
const verifyTheButtonsInTheSubmitPage = () => {
    try {
        ...
        browser.sleep(2000);
        console.log("User Can able To Click On Question Numbers and Navigate To The Questions On Question Set ");
...
const verifyTheAlignmentOfTitleAndQuestonNumber = () => {
  ...
  const createBookWithLabelValidation = async () => {
    try {
        ...
        browser.sleep(4000);
        expect((searchObj.assertMultiselectAdditionalCategory).isPresent()).toBe(true);
        browser.sleep(5000);
        let multiValuesPreSelected = await searchObj.assertMultipleAdditionalCategoryValues.getText();
        ...
        browser.sleep(3000);
        let multipleValues = await searchObj.assertMultipleAdditionalCategoryValues.getText();
...
const createCourseAndSendForReviewWithCBSECoureType = () => {
    ...
    try {
        ...
        sanityPage.SanityElement().courseType.click();
        browser.sleep(2000);
        expect(sanityPage.SanityElement().selectcourseTypeForK12.isPresent()).toBeTruthy();
        browser.sleep(2000);
...
const writeToCsvFile = async (dataToWrite) => {
    ...
    var fs = require('fs');
    await fs.writeFile('C:\\Users\\Qualitrix\\Downloads\\createfoldersamplecsvfile.csv', dataToWrite, 'utf8', function (err) {
      if (err) {
        console.log('Some error occured - file either not saved or corrupted file saved.');
      } else {
        console.log('It\'s saved!');
...
const verifyBackButtonIsPresentInIndividualAssetsOnconsumptionScreen = () => {
    try {
        ...
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.clkAndConsume), 20000, "Content Not Available");
        searchObj.clkAndConsume.click();
        browser.sleep(3000);

        expect(searchObj.assertBackBtn.isPresent()).toBeTruthy().then(function () {
    ...
    try {
        for(var i =0;i<=1;i++){
            ...
            if(i==0){
                ...
                (searchObj.toastMessage.getText())
...
const verifyQuestionPaperContentwithsameContent = () => {
    try {
        for(var i =0;i<=1;i++){
            ...
            sanity.filterApplyButton.click();
            browser.sleep(2000);
            let libraryContent = genericFun.readParticularDataFromExcelFile(getExcelPath.ConfigurePath().excelSheetPath, '3')[45]['CourseDescription'];
            sanityPage.SanityElement().searchLibrary.sendKeys(libraryContent);
            browser.sleep(1000);
            sanityPage.SanityElement().searchLibrary.sendKeys(protractor.Key.ENTER);
            browser.sleep(6000);
            browser.executeScript("arguments[0].scrollIntoView();", sanity.assertAddedToCollection);
            expect((sanity.assertAddedToCollection).isPresent()).toBe(true);
            sanityPage.SanityElement().selectButton.click();
            browser.sleep(6000);
            if(i==0){
...
const verifyDigitalTextBookContent = () => {
    try {
        for(var i =0;i<4;i++){
            ...
            sanityPage.SanityElement().addFromLibraryButton.click();
            browser.sleep(4000);
            sanityPage.SanityElement().searchLibrary.sendKeys("do_21355452901534105611539");
            browser.sleep(1000);
            sanityPage.SanityElement().searchLibrary.sendKeys(protractor.Key.ENTER);
            browser.sleep(6000);
            // sanity.changeFiltersInLibraryPageOfEditor.click();
...
const addContentToCourseInFourDifferentLevels = (libraryContent) => {
    try {
        for(var i =0;i<4;i++){
            ...
            browser.sleep(500);
            //sanity.addCourseTitle.click();
            browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.addCourseTitle), 20000, "Course creation editor never loaded");
...
const addContentToCourseWithfirstFolders = () => {
    try {
        for(var i =0;i<=1;i++){
            ...
            let libraryContent = genericFun.readParticularDataFromExcelFile(getExcelPath.ConfigurePath().excelSheetPath, '3')[44]['CourseDescription'];
            sanityPage.SanityElement().searchLibrary.sendKeys(libraryContent);
            browser.sleep(1000);
            sanityPage.SanityElement().searchLibrary.sendKeys(protractor.Key.ENTER);
            browser.sleep(6000);
...
const addContantPlaylistFolderWithSamecontent = () => {
    try {
            for(var i =0;i<=1;i++){
                ...
                sanity.filterApplyButton.click();
                browser.sleep(2000);
                let libraryContent = genericFun.readParticularDataFromExcelFile(getExcelPath.ConfigurePath().excelSheetPath, '3')[43]['CourseDescription'];
                sanityPage.SanityElement().searchLibrary.sendKeys(libraryContent);
                browser.sleep(1000);
                sanityPage.SanityElement().searchLibrary.sendKeys(protractor.Key.ENTER);
                browser.sleep(6000);
...
const addCourseFolderWithSamecontent = () => {
    try {
            for(var i =0;i<=1;i++){
                ...
                sanity.filterApplyButton.click();
                browser.sleep(2000);
                let libraryContent = genericFun.readParticularDataFromExcelFile(getExcelPath.ConfigurePath().excelSheetPath, '3')[46]['CourseDescription'];
                sanityPage.SanityElement().searchLibrary.sendKeys(libraryContent);
                browser.sleep(1000);
                sanityPage.SanityElement().searchLibrary.sendKeys(protractor.Key.ENTER);
                browser.sleep(6000);
...
const createCollectionWithDiffCollectionTypesToAddSameContentinContentPlaylistCollection = (collectionType) => {
    var collectionName;
    try {
...
const createCollectionWithDiffCollectionTypesToAddSameContentinQuestionPaperCollection = (collectionType) => {
    var collectionName;
    try {
        console.log("User is trying to create a collection")
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.headerDropdown), 20000, "headerDropdown page not loaded");
...
const createCollectionWithDiffCollectionTypesAndValidateSomeAttributes = (collectionType) => {
    var collectionName;
    try {
        console.log("User is trying to create a collection");
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.headerDropdown), 20000, "headerDropdown page not loaded");
...
const createCollectionWithDiffcontentPlaylistAndQuestionPaperTypes = (collectionType) => {
    var collectionName;
    try {
        console.log("User is trying to create a collection");
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.headerDropdown), 20000, "headerDropdown page not loaded");
...
const verifyAddActivitySearchedByKeyword = (keywords) => {
    try {
        ...
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.clkCourseInGroup), 40000, "Course not available");
        searchObj.clkCourseInGroup.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(etbobj.searchContentInGroup),40000,"Next button not available");
        etbobj.searchContentInGroup.sendKeys(keywords);
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(etbobj.searchButtonForGroup),40000,"Next button not available");
...
const createCourseWithPdfMp4AndCourseAssessment = () => {
    ...
    try {
        ...
        browser.sleep(4000);
        sanityPage.SanityElement().searchLibrary.clear();
        sanityPage.SanityElement().searchLibrary.sendKeys(cred[47]['CourseDescription']);
        browser.sleep(1000);
        sanityPage.SanityElement().searchLibrary.sendKeys(protractor.Key.ENTER);
        browser.sleep(6000);
        sanityPage.SanityElement().selectButton.click();
...
const createCollectionWithDiffCollectionTypesToAddSameContentinContentPlaylistWithDoubleQuotes = (collectionType) => {
    var collectionName;
    try {
        console.log("User is trying to create a collection")
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.headerDropdown), 20000, "headerDropdown page not loaded");
...
const clickOnActivityInGroupAndValidateProgressBar = async () => {
    try {
        console.log('user is able to click on added Activity and validate content progress bar');
        browser.sleep(4000);
        ...
        searchObj.addingMembertoGroup.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.backButton), 40000, "adding member group not available");
        sanity.backButton.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.firstContent), 40000, "Profile Button not available");
        sanity.firstContent.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.activityDashBoard), 40000, "Profile Button not available");
        ...
        console.log('user is unable to click on added Activity and validate content progress bar');
    }
}
...
const targetFrameworkWithMultipleCategoricalValuesAndValidateCourseTypesValues = (FrameworkName) => {
    try {
        console.log("user is trying to create a course")
        browser.sleep(1000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.headerDropdown), 20000, "headerDropdown page not loaded");
        ...
        expect(sanityPage.SanityElement().assert3Dot7frame.isPresent()).toBeTruthy();
        browser.sleep(1000);
        if (FrameworkName === "k12") {
            sanityPage.SanityElement().k12.click();
        } else if (FrameworkName === "CPD") {
...
const clickOnActivityInGroupAndDownloadCsvAndValidate = async () => {
    try {
        ...
        browser.sleep(5000);
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"AutomationCourseCompletedBatch.csv",0,"Name","ABC");
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"AutomationCourseCompletedBatch.csv",1,"Name","content reviewer");
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"AutomationCourseCompletedBatch.csv",2,"Name","Test");
        browser.sleep(4000);
        let progressBar = await sanity.assertTable.getText();
        progressBar.includes("Test");
    }
...
const clickOnActivityInGroupandValidatePercenceteageCompleted = async () => {
    try {
        ...
        sanity.activityDashBoard.click();
        browser.sleep(3000);
        expect(searchObj.assertPercentageInActivityDashBoard.isPresent()).toBe(true);
    }
    catch (Exception) {
        console.log('user is unable to click on added Activity and validate content progress bar');
    }
...
const clickAddedActivityAndConsume = () => {
    try {
        ...
        sanity.firstContent.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.clkJoinCourse), 40000, "Profile Button not available");
        searchObj.clkJoinCourse.click();
        browser.sleep(3000);
...
const vlidateSomeColumnHeadersInSampleCSV = async () => {
    try {
        ...
        // browser.sleep(5000);
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"createfoldersamplecsvfile.csv",0,"Level 1 Folder","5. Human Body");
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"createfoldersamplecsvfile.csv",1,"Level 2 Folder","5.1 Parts of Body");
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"createfoldersamplecsvfile.csv",2,"Level 3 Folder","5.1.1 Key parts in the head");
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"createfoldersamplecsvfile.csv",3,"Level 3 Folder","5.1.2 Other parts");
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"createfoldersamplecsvfile.csv",3,"Level 3 Folder","5.1.2 Other parts");
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"createfoldersamplecsvfile.csv",2,"Level 4 Folder","");
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"createfoldersamplecsvfile.csv",0,"Description","This chapter describes about human body");
        genericFun.validateParticularDataCSVFile(getExcelPath.ConfigurePath().downloadLocalPath+"createfoldersamplecsvfile.csv",1,"Description","This section describes about various part of the body such as head, hands, legs etc.");
        browser.sleep(4000);
    }
    catch (Exception) {
        console.log('user is unable to click on added Activity and validate content progress bar');
...
const validateRemoveActivity = async () => {
    try {
        ...
        browser.sleep(1000);
        var removeActivityMessage = await searchObj.toastMessage.getText();
        expect(removeActivityMessage).toEqual("Activity removed for the group successfully");
        browser.sleep(2000);
...
const validateSearchAddedMemberAndCout = async () => {
    try {
        ...
        searchObj.searchWithInGroup.sendKeys("testSpider");
        browser.sleep(4000);
        searchObj.memberHamburgerMenu.click();
        browser.sleep(4000);
        ...
        searchObj.removeMember.click()
        browser.sleep(4000);
        expect(searchObj.assertAddedMemberAfterRemovingOnce.isPresent()).toBe(false);
        browser.sleep(4000);
        browser.executeScript('window.scrollTo(0,0);').then(function () {
            console.log('++++++SCROLLED Down+++++');
        });
...
const validateSomeAttributesInCollaborations = async () => {
    ...
    try {
        ...
        content.workSpace.click();
        browser.sleep(200);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.clkCollaborationSection), 20000, "Creation page not loaded");
...
const validateCentreAlignementofTabs = async () => {
    try {
        ...
        var asserCentreAlignment = await (sanity.sixTabsCentraAlignMent).getCssValue('align-items');
...
const validateUserAbletoSearchMemberAndLeaveGroupwithConfirmationPopUp = async (groupName) => {
    try {
        var1 = "//div[contains(text(),'";
        var2 = groupName;
        var3 ="')]";
        ...
        searchObj.searchWithInGroup.sendKeys("testSpider");
        browser.sleep(4000);
        expect(searchObj.assertSearchedSecondMemberInMemberGroup.isPresent()).toBe(true);
        browser.sleep(4000);
        searchObj.searchWithInGroup.clear();
        searchObj.searchWithInGroup.sendKeys("Content reviewer");
        browser.sleep(4000);
...
const validateAdminNameIsPresentOnTopAndMembersArrangedAlphabetically = async () => {
    try {
        console.log('user is able to click on added Activity and validate content progress bar');
        browser.sleep(4000);
        console.log('user is able to create myGroup,add member and addActivity');
        ...
        utility.checkStringSortedAlphabeticallyOrNot(groupMembersList,sortedMemberAlphabtically);
        browser.sleep(3000);
    }
    catch (Exception) {
        console.log('user is unable to click on added Activity and validate content progress bar');
...
const validateUserIsPresentAtTheTop = async (groupName) => {
    try {
        ...
        browser.sleep(5000);
        expect(searchObj.assertUserComesFirstOntopWithMembers.isPresent()).toBe(true);
        //expect(searchObj.assertAdminPresentFirstUnderAddMember.isPresent()).toBe(true);
        browser.sleep(8000);
    } catch (err) {
        console.log(err);
...
const validateUserAbletoCreateThreadAndReply = async (groupName) => {
    try {
        ...
        sanityPage.SanityElement().submitButton.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.assertSavedPost), 20000, "assertSavedPost is not available");
        content.assertSavedPost.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.ReplyMessage), 20000, "ReplyMessage is not available");
...
const verifyAddActivitySearchedAndValidateRecommendationAndFilters = (keywords) => {
    try {
        console.log('user is able to create myGroup,add member and addActivity');
        browser.wait(protractor.ExpectedConditions.visibilityOf(searchObj.profileButton), 40000, "Profile Button not available");
        searchObj.profileButton.click();
        ...
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.selectOrg), 40000, "Filter button not available");
        sanity.selectOrg.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(content.selectOrgValue), 40000, "Cross button not available");
        content.selectOrgValue.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.selectRole), 40000, "Cross button not available");
        sanity.selectRole.click();
        browser.sleep(3000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.selectRoleValue), 40000, "Cross button not available");
        sanity.selectRoleValue.click();
        browser.sleep(3000);
        expect(sanity.assertContentCard.isPresent()).toBe(true);
        browser.sleep(3000);
    }
...
const validateContentInPublishedSectionAfterPublishmentOfContent = async (bookname) => {
    try {
        browser.wait(protractor.ExpectedConditions.visibilityOf(ccpage.contentCreation().headerDropdown), 20000, "headerDropdown page not loaded");
        ccpage.contentCreation().headerDropdown.click();
        browser.sleep(1000);
        ...
        browser.sleep(1000);
        browser.sleep(4000);
        browser.wait(protractor.ExpectedConditions.visibilityOf(sanity.publishedTab), 40000, "allMyContent is not available");
...
const verifyWhenUserReplaysTheQuestionSetItShouldStartFromInstructionPage = () => {
    ...
    try {
        ...
        console.log("On Click Replay button It will Start From Instruction Page ");
