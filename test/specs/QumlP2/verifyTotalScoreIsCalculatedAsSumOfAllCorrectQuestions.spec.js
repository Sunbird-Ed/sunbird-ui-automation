...
describe('Verify creator is able to enter the marks in the Marks field', () => {
    ...
    it('verifyTotalScoreIsCalculatedAsSumOfAllCorrectQuestions',function(){
        utility.handleDropDown();
        utility.handleLocationPopup();
        utility.userLogin('ContentCreator1');
        resourcePageObj.createQuestionSetWithShuffleDisbleAndAssignMarksToEachQuestionsWithTypeComplete();
