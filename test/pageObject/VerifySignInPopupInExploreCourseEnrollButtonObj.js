...
const validateTextBookCount = () => {
  var count;
  try {
    console.log("User is trying to validateTextBookCount");
    browser.sleep(1000);
    browser.wait(protractor.ExpectedConditions.visibilityOf(content.BookCount), 20000, "BookCount is not available");
    browser.sleep(1000);
...
const validateTextBookCountInDifferentRole = (bookCnt) => {
  var count;
  try {
    console.log("User is trying to validateTextBookCountInDifferentRole");
    browser.sleep(1000);
    browser.wait(protractor.ExpectedConditions.visibilityOf(content.BookCount), 20000, "BookCount is not available");
    browser.sleep(1000);
    expect(content.BookCount.isDisplayed).toBeTruthy();
