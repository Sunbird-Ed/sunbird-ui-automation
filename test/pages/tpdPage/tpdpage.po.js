...
const tpdPage = () => {
    ...
    var childNode = element(by.xpath("//span[contains(@title,'Chapter')]"));
    ...
    var viewAllButtonForrecentlyPublishedCourse = element(by.xpath("(//button[contains(text(),' View all ')])[1]"));
