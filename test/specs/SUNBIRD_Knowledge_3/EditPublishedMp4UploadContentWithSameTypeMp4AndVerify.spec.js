...
describe('upload pdf, save and send for review and publish.', () =>{
    ...
    it('EditPublishedMp4UploadContentWithSameTypeMp4AndVerify ',function(){
        ...
        sanityFun.validateContentInPublishedSectionAfterPublishmentOfContent(Mp4);
        uploadPageObj.ReuploadSameTypeForLiveUploadContent('MP4');
        utility.userLogout();
         utility.userLogin('Reviewer');
            resourcePageObj.publishTheResourceFromUpForReview(Mp4);
