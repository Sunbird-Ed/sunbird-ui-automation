...
describe('User clicks on Enable option under the action column to go to Conversation Setup screen', () => {
    ...
    it('verifyConversationStatusIsChangedToLiveWhenClicksOnEnableOption',function(){
        ...
        EnrollTBFCPageObj.verifyConversationStatusIsChangedToLiveWhenClicksOnEnableOption();
