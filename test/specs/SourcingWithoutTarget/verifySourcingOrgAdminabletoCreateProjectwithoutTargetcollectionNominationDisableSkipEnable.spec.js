...
describe('Verify create Project Without Target Collection same Org Skip Enable ', () => {
    ...
    it('verifycreateProjectWithoutTargetCollectionNominationDisableSkipEnable',function(){
