...
describe('createCollectionsWithDifferentCollectionType', () => {
    ...
    it('createCollectionsWithDifferentCollectionType', function () {
        utility.handleDropDown();
        utility.handleLocationPopup();
        utility.userLogin('Creator');
        let collectionName = collectionPageObj.createCollectionWithDiffCollectionTypes("digitalTxtbook");
        let collectionName1= collectionPageObj.createCollectionWithDiffCollectionTypes("contentPlaylist");
